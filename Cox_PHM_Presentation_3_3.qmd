...
![Table 1: Summary of First 15 rows of Heart Transplant Dataset](Head_data_set.png)
...
![Table 2: Excluding Wait Time](Table_1.png)
...
![Table 3: Including Wait Time for Transplant Recipient](Table_3_Including_wait_time.png)
...
![Table 4: Without Accepted Year](Table_3.png)
...
![Image 1: Residual Plot](Image 1 Residual plot.png)
...
![Table 6: Proportional Hazard p-value](Table 6 Proportional Hazard.png)
...
![Table 7: Stratified Transplant Status](Table 7 Stratified Transplant.png)

![]()

## Histogram by Age Groups {.scrollable}

![Image2: Histogram by Age](Histogram_of_age.png)
...
![Image 3: Histogram by Age Groups](Histogram_of_age2.png)
...
![Table 8: Age Categorized](Table 8 Age categorized.png)
...
![Image 4: Survival Plot](Survival_Plot.png)
